...
const addClothCompleteCloth = async (title, price, size, pictureURL, colorHexCode) => {
  try{
    let abstractCloth = await abstractClothModel.create({title: title, price: price, pictureURL: pictureURL})
